...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/06 15:05:28 by mmonika           #+#    #+#             */
/*   Updated: 2025/07/14 12:40:02 by mmonika          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target)
{
	if (hit < 1)
	{
		std::cout << "ClapTrap: " << name << " is out of hit points (NO ATTACK) 💀" << std::endl;
		return;
	}
	else if (energy > 0)
	{
	...
	{
		std::cout << "ClapTrap: " << name << " is out of energy (NO ATTACK) 😵" << std::endl;
		return;
	}
}
